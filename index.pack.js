...
var _dropbox = __webpack_require__(0);
...
function render(entry) {
    (0, _jquery2.default)('#myFiles').append('<li class="' + entry['.tag'] + '">' + entry.name + '</li>');
}
